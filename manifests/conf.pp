...
define corosync::conf (
  ...
  $manage_require = pickx($require, $corosync::config_file_require)
  $manage_notify  = pickx($notify, $corosync::manage_config_file_notify)
  $manage_replace = pickx($replace, $corosync::config_file_replace)
